...
Yes! All the code we used to train the models is available to generate ML classifiers for other species (https://gitlab.com/sirarredondo/analysis_mlplasmids)
